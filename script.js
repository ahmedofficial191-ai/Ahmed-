...
window.addEventListener('load', () => {
    ...
    if (typingElement) {
        typeWriter(typingElement, 'مرحباً، أنا', 150);
    }
});
...
if (contactForm) {
    contactForm.addEventListener('submit', (e) => {
        ...
        const subject = contactForm.querySelector('input[placeholder="الموضوع"]').value;
...
window.addEventListener('load', () => {
    ...
    const loadingElements = document.querySelectorAll('.hero-text, .profile-card, .feature, .skill-item, .project-card');
